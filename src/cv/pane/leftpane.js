    ...
    const renderProfile = () => (
        <Fragment>
            ...
            <div>
                ...
                <div style={{float: 'left', marginTop: 10, marginLeft: '20px', textAlign: 'left', color: 'antiquewhite', fontFamily: "'Raleway', sans-serif", fontWeight: '100', fontSize: '11px'}}>
            ...
            <div>
                ...
                <div style={{width: '88%', marginTop: 10, float: 'left', marginLeft: '25px', textAlign: 'left', color: 'antiquewhite', fontFamily: "'Raleway', sans-serif", fontWeight: '100', fontSize: '11px'}}>
                    <div style={{width: '100%'}}>
                        ...
                        <div style={{width: '90%', height: '2px', background: 'purple', position: 'relative', top: '-2px'}} ></div>
                    </div>

                    <div style={{width: '100%'}}>
                        <span>Data Structure</span>
                        <div style={{width: '100%', height: '2px', background: 'white'}}></div>
                        <div style={{width: '70%', height: '2px', background: 'purple', position: 'relative', top: '-2px'}} ></div>
                    </div>

                    <div style={{width: '100%'}}>
                        <span>JavaScript</span>
                        <div style={{width: '100%', height: '2px', background: 'white'}}></div>
                        <div style={{width: '80%', height: '2px', background: 'purple', position: 'relative', top: '-2px'}} ></div>
                    </div>

                    <div style={{width: '100%'}}>
                        <span>ReactJS</span>
                        <div style={{width: '100%', height: '2px', background: 'white'}}></div>
                        <div style={{width: '85%', height: '2px', background: 'purple', position: 'relative', top: '-2px'}} ></div>
                    </div>
